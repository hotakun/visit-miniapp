...
const COLLECTIONS = ['users', 'customers', 'tasks', 'visits', 'orders', 'import_batches', 'settings', 'coord_fix_requests', 'salesman_locations', 'mall_claims', 'mall_customers', 'customer_batches', 'batch_members', 'registrations', 'transcripts'];
